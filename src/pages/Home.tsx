        ...
        {activeSection === 'contact' && (
          <section className="section active" id="section-contact">
            ...
            <div className="social-links">
              {[
                {
                  label: 'LinkedIn', href: 'https://www.linkedin.com/in/geo-nithin-046a05331',
                  svg: <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 24 24" fill="currentColor"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>
                },
                {
                  label: 'GitHub', href: 'https://github.com/geonithin',
                ...
                {
                  label: 'Instagram', href: 'https://www.instagram.com/geonithin_',
                  svg: <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
                },
                {
                  label: 'Discord', href: 'https://discord.com/channels/@geonithin_',
                ...
                {
                  label: 'WhatsApp', href: 'https://wa.me/918248566027',
                ...
                {
                  label: 'LeetCode', href: 'https://leetcode.com/u/geonithin',
                ...
                {
                  label: 'MS Learn', href: 'https://learn.microsoft.com/en-us/users/geonithin-3229/',
                  svg: <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 24 24" fill="currentColor"><path d="M11.4 24H0V12.6h11.4V24zM24 24H12.6V12.6H24V24zM11.4 11.4H0V0h11.4v11.4zm12.6 0H12.6V0H24v11.4z"/></svg>
                },
                {
                  label: 'Duolingo', href: 'https://duolingo.com/profile/GEONITHIN',
                  svg: <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 24 24" fill="currentColor"><path d="M19.433 8.727c.236-.75.353-1.538.353-2.34C19.786 2.862 17.01 0 13.515 0c-1.41 0-2.743.48-3.81 1.35C8.97.48 7.635 0 6.225 0 2.73 0 0 2.86 0 6.387c0 .788.114 1.56.338 2.294C.122 9.396 0 10.156 0 10.927c0 3.527 2.73 6.39 6.225 6.39.35 0 .697-.03 1.035-.086L12 24l4.74-6.77c.338.058.685.087 1.035.087C21.27 17.317 24 14.454 24 10.927c0-.77-.122-1.53-.338-2.246l-.229.046z"/></svg>
                },
              ].map(({ label, href, svg }) => (
                <a key={label} href={href} target="_blank" rel="noopener noreferrer" className="social-link">
                  <span className="social-link__icon">{svg}</span>
